...
<html>
 ...
 <body>
  ...
  <script type="text/javascript" src="/static/js/config.js?20180831"></script>
  <script>
    BUI.use('common/main',function(){
      var config = [{
          ...
          menu:[{
              text:'首页内容',
              items:[
                {id:'code',text:'首页代码',href:'/api/list',closeable : false},
                {id:'main-menu',text:'顶部导航',href:'/api/table'},
